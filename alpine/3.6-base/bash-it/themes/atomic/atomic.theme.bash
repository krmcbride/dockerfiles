...
___atomic_prompt_user_info() {
  ...
  #info="${IYellow}\u${IRed}@${IGreen}\h"   krmcbride: dockerize it
  info="${IYellow}\u${IRed}🐋 ${IGreen}\h" # krmcbride: dockerize it
...
#___ATOMIC_TOP_RIGHT=${___ATOMIC_TOP_RIGHT:-"exitcode python ruby todo clock battery"} krmcbride: remove unnecessary items
___ATOMIC_TOP_RIGHT=${___ATOMIC_TOP_RIGHT:-"exitcode clock"}                         # krmcbride: remove unnecessary items
