...
#POWERLINE_LEFT_PROMPT=${POWERLINE_LEFT_PROMPT:="scm python_venv ruby cwd"}         krmcbride: remove unnecessary items
POWERLINE_LEFT_PROMPT=${POWERLINE_LEFT_PROMPT:="scm cwd"}                         # krmcbride: remove unnecessary items
#POWERLINE_RIGHT_PROMPT=${POWERLINE_RIGHT_PROMPT:="in_vim clock battery user_info"} krmcbride: remove unnecessary items
POWERLINE_RIGHT_PROMPT=${POWERLINE_RIGHT_PROMPT:="in_vim clock user_info"}        # krmcbride: remove unnecessary items
